...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        labelfname.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        ...
        labelfcode.setBorder(BorderFactory.createLineBorder(Color.BLACK));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                String query = "insert into resrvations values('PNR-" + random.nextInt(1000000) + "', 'TIC-" + random.nextInt(10000) + "', '" + aadhar + "', '" + name + "', '" + nationality + "', '" + flightname + "', '" + flightcode + "', '" + src + "', '" + des + "', '" + ddate + "')";
